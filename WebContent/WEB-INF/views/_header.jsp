...
<div class="col-md-12"
	...
	<div class="col-md-10" style="font-size: 23px; cursor: pointer">
		<div class="col-md-3 gradient" id="homeURL">English Subtitles</div></div>
